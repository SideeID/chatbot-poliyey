...
import { Send, MessageSquare, SparklesIcon, AlertTriangle } from 'lucide-react';
...
export function Chat() {
  ...
  const handleFormSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (profanityCheck.isProfane) {
      ...
      setProfanityWarning(
        'Mohon maaf, pesan Anda mengandung kata-kata yang kurang sopan. Kami tidak dapat memproses pertanyaan yang mengandung kata-kata tidak pantas. Silakan ajukan pertanyaan Anda dengan bahasa yang lebih sopan.',
      );
      ...
      toast({
        ...
        description:
          'Mohon gunakan bahasa yang sopan dalam berkomunikasi dengan JEMPOL.',
        variant: 'destructive',
        duration: 3000,
      });
    ...
    // Hapus peringatan jika tidak ada kata kotor
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Tampilkan peringatan profanity jika ada */}
        {profanityWarning && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className='p-3 my-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg'
          >
